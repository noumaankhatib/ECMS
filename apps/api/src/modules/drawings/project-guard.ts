...
/**
 * Refuses any mutation on a closed project. Identical to every other
 * module's guard of the same name — duplicated rather than imported, because
 * a module may only reach into another module's `index`, and this helper is
